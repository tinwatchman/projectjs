module.exports = (function() {
    ...
    var ProjectJsRunner = function() {
         ...
         * @param  {ProjectJsRegistry}   projectRegistry ProjectJsRegistry object
         * @param  {Function}            callback        Callback function. Optional.
         * @return {void}
         */
        this.run = function(projectDir, project, projectRegistry) {
            if (!project.hasStart()) {
            ...
            if (arguments.length > 3 && _.isFunction(arguments[3])) {
