...
var ProjectJsCompiler = function() {
    ...
    this.replaceUses = function(filePath, code, registry) {
        ...
        for (var i=0; i<len; i++) {
            ...
            } else if (_.isObject(classPath)) {
                // if a package
                replaceStr = this.makePackageRequireMap(filePath, regPath);
            }
    ...
    this.makePackageRequireMap = function(filePath, map) {
        ...
        return util.writeObjectStr(requireMap);
    };
